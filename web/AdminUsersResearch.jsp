...
<body>
    ...
    <section class="hero is-fullheight">
        ...
        <div class="buttons is-right">
            <a href="AdminUsers.jsp" style="margin-top:20px;" class="button is-black"><span class="icon">
                        ...
                        try{
                          ...
                          <div class="box">
                                       ...
                                       <div class="media-content">
                                         <div class="content">                                          
                                           <ul>
                                               <li><strong>Num : </strong><%=rs.getString("id")%></li>
                                               <li><strong>Nom : </strong><%=rs.getString("nom")%></li>
                                               <li><strong>Prenom : </strong><%=rs.getString("prenom")%></li>
