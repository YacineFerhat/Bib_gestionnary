                        ...
                        <div class="box">
                            <form action="UpdateWriter.jsp" method="post" enctype="multipart/form-data">
                               <%
                                ...
                                String data = "select * from auteur where num='"+ num +"'";
                                  ...
                                  <div class="field-body">
                                      <div class="field">
                                          <p class="control is-expanded has-icons-left has-icons-right">
                                              <input value='<%=res.getString("DateDeNaissance")%>' class="input" type="date" name="DateDeNaissance">                                                <span class="icon is-small is-left">
                                          </p>
                                      </div>    
                                  </div>
                              </div>
